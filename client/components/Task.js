    ...
    <section className='task-list task-item container'>
      <button className='move' onClick={() => handleMoveLeft()}>
        <svg
          ...
          height='32'
          fill='currentColor'
          className='bi bi-arrow-left-short moveButton'
          viewBox='0 0 16 16'
        >
          <path
            fillRule='evenodd'
        ...
        {editContent ? (
          <div className='modal'>
            ...
            <div className='modalButtonArea'>
              <button
                className='modalSubmitButton modalButton'
                onClick={() => handleSubmitTextBtn()}
              >
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  width='16'
              ...
              <button
                className='modalCancelButton modalButton'
                onClick={() => handleCancelTextBtn()}
              >
                <svg
                  xmlns='http://www.w3.org/2000/svg'
                  width='16'
      ...
      <button className='move' onClick={() => handleMoveRight()}>
        <svg
          ...
          height='32'
          fill='currentColor'
          className='bi bi-arrow-right-short moveButton'
          viewBox='0 0 16 16'
        >
          <path
            fillRule='evenodd'
